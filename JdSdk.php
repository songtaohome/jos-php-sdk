...
$pt = "my cipher";
$accessToken = "596f309be35643c88abefce9799e2ac2owjl";
$appKey = "39B4F855DA79FB68B53CCED349362BA8";
$appSecret = "6594847ca79a44a9884c88ce91a2b1fb";
$tde = SecretJdClient::getInstance($accessToken, $appKey, $appSecret);

$ct = $tde->encrypt($pt);

$tde = SecretJdClient::getInstance($accessToken, $appKey);
